<template>
  <div>
    ...
    <!-- 添加分类的对话框 -->
    <el-dialog title="添加分类" :visible.sync="addCatDialogVisable" width="50%" @close="addCateDialogClosed">
      <!-- 添加分类的表单 -->
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
            <!-- option用来指定数据源 -->
            <!-- props 用来指定配置对象 -->
          <el-cascader v-model="selectedKeys" :props="cascaderProps" :options="prentCateList" expand-trigger="hover" @change="parentCatChanged" clearable change-on-select></el-cascader>
        </el-form-item>
      </el-form>
